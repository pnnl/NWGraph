# copied from https://github.com/vector-of-bool/CMakeCM and modified slightly
...
if(_CXX_FILESYSTEM_HAVE_HEADER)
    set(_have_fs TRUE)
    set(_fs_experimental FALSE)
    set(_fs_header filesystem)
    set(_fs_namespace std::filesystem)
elseif(_CXX_FILESYSTEM_HAVE_EXPERIMENTAL_HEADER)
    set(_have_fs TRUE)
    set(_fs_experimental TRUE)
...
set(CXX_FILESYSTEM_IS_EXPERIMENTAL ${_fs_experimental} CACHE BOOL "TRUE if the filesystem is experimental")
