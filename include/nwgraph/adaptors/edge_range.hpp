...
public:
  ...
  public:
    ...
    using value_type =
        std::tuple<vertex_id_type, vertex_id_type,
  ...
  public:
    ...
    my_iterator(const my_iterator<false>& rhs)
      requires(is_const)
        : base_(rhs.base_), first_(rhs.first_), last_(rhs.last_), u_begin_(rhs.u_begin_), u_end_(rhs.u_end_) {
    }

    my_iterator& operator=(const my_iterator&) = default;
    my_iterator& operator=(const my_iterator<false>& rhs)
      requires(is_const)
    {
      base_    = rhs.base_;
      first_   = rhs.first_;
