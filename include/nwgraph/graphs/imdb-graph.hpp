...
#ifndef NW_GRAPH_IMDB_GRAPH_HPP
#define NW_GRAPH_IMDB_GRAPH_HPP

#include <string>
#include <vector>

std::vector<std::string> actors {
  "Tom Cruise",    "Kevin Bacon",    "Hugo Weaving", "Carrie-Anne Moss",  "Natalie Portman", "Jack Nicholson", "Kelly McGillis",
  "Harrison Ford", "Sebastian Stan", "Mila Kunis",   "Michelle Pfeiffer", "Keanu Reeves",    "Julia Roberts",
};

std::vector<std::string> movies {
  "A Few Good Men", "Top Gun", "Black Swan", "V for Vendetta", "The Matrix", "Witness", "What Lies Beneath", "Closer", "Flatliners",
};
