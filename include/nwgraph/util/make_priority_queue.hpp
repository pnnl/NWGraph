...
namespace graph {
/**
 * Create a priority queue with the specified container and comparison.
 *
 * @tparam T The type of the stored element.
 * @tparam Container The container type for the priority queue.
 * @tparam Compare The type of the comparison object.
 * @param compare The comparison object to use.
 * @return A `std::priority_queue` instantiated with the proper types.
 */
 ...
 * @tparam Compare The type of the comparison object.
 * @param compare The comparison object to use.
 * @return A `std::priority_queue` wrapping a `std::vector<T>` that
