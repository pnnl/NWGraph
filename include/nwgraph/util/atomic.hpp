 ...
 * @tparam order Memory order for the operation.
 ...
 * @return true if the compare and exchange succeeded, false otherwise (`u` is updated).
 */
...
/**
 * Load the value using relaxed semantics.
 *
 * @tparam T The type of the variable to load from.
 * @param t The variable to load from.
 * @return The loaded value.
...
/**
 * Store the value using relaxed semantics.
 *
 * @tparam T The type of the variable to store to.
 * @tparam U The type of the value to store.
 * @param t The variable to store to.
 ...
 * @return The value of the variable prior to the add operation.
 */
 ...
 * Atomic fetch-and-or.
 *
 * This provides a uniform atomic fetch-and-or API interface that works for
 * atomic and non-atomic integral types.
 *
 * @tparam order The memory order for the operation [default: acquire/release].
 * @tparam T The type of the variable.
 * @tparam U The type of the value to OR.
 * @param t The variable to modify.
 * @param u The value to OR.
 * @return The value of the variable prior to the OR operation.
 */
template <std::memory_order order = std::memory_order_acq_rel, class T, class U>
